...
""", [
    ...
    ("comment", "comment1a\n-></foo><bar>&lt;<?pi?></foo<bar\ncomment1b"),
    ("data", "\n"),
    ("starttag", "Image", [("src", "Bar"), ("ismap", None)]),
    ("data", "sample\ntext\n"),
    ("charref", "x201C"),
    ("data", "\n"),
    ...
    def test_startendtag(self):
        ...
        self._run_check("<p><Image src='foo' /></p>", [
            ("starttag", "p", []),
            ("startendtag", "Image", [("src", "foo")]),
            ("endtag", "p"),
            ])
    ...
    def test_slashes_in_starttag(self):
        ...
        html = ('<Image width=902 height=250px '
    ...
    def test_broken_condcoms(self):
        ...
        html = ('<![if !(IE)]>broken condcom<![endif]>'
                ...
                '<![if !IE 6]><Image src="firefox.png" /><![endif]>'
                '<![if !ie 6]><b>foo</b><![endif]>'
                '<![if (!IE)|(lt IE 9)]><Image src="mammoth.bmp" /><![endif]>')
        ...
        expected = [
            ...
            ('startendtag', 'Image', [('src', 'firefox.png')]),
            ('unknown decl', 'endif'),
            ('unknown decl', 'if !ie 6'),
            ('starttag', 'b', []),
            ('data', 'foo'),
            ...
            ('startendtag', 'Image', [('src', 'mammoth.bmp')]),
            ('unknown decl', 'endif')
        ]
        self._run_check(html, expected)
...
class AttributesTestCase(TestCaseBase):
    ...
    def test_attr_nonascii(self):
        # see issue 7311
        self._run_check(
            "<Image src=/foo/bar.png alt=\u4e2d\u6587>",
            [("starttag", "Image", [("src", "/foo/bar.png"),
                                  ("alt", "\u4e2d\u6587")])])
        self._run_check(
