...
class BitmapImageTest(AbstractTkTest, unittest.TestCase):
    ...
    def test_create_from_file(self):
        image = tkinter.BitmapImage('::Image::test', master=self.root,
                                    foreground='yellow', background='blue',
                                    file=self.testfile)
        self.assertEqual(str(image), '::Image::test')
        self.assertEqual(image.type(), 'bitmap')
        self.assertEqual(image.width(), 16)
        self.assertEqual(image.height(), 16)
        self.assertIn('::Image::test', self.root.image_names())
        del image
        self.assertNotIn('::Image::test', self.root.image_names())
...
class PhotoImageTest(AbstractTkTest, unittest.TestCase):
    ...
    def create(self):
        return tkinter.PhotoImage('::Image::test', master=self.root,
                                  file=self.testfile)
    ...
    def check_create_from_file(self, ext):
        ...
        image = tkinter.PhotoImage('::Image::test', master=self.root,
                                   file=testfile)
        self.assertEqual(str(image), '::Image::test')
    ...
    def test_write(self):
        ...
        image2 = tkinter.PhotoImage('::Image::test2', master=self.root,
                                    format='ppm',
                                    file=support.TESTFN)
        self.assertEqual(str(image2), '::Image::test2')
        ...
        image3 = tkinter.PhotoImage('::Image::test3', master=self.root,
                                    format='gif',
                                    file=support.TESTFN)
        self.assertEqual(str(image3), '::Image::test3')
